...
class CustomerContactsControllerTest < ActionController::TestCase
  ...
  test "should create customer_contact" do
    assert_difference('CustomerContact.count') do
      post :create, customer_contact: { cell: @customer_contact.cell, designation: @customer_contact.designation, email: @customer_contact.email, first_name: @customer_contact.first_name, last_name: @customer_contact.last_name, middle_name: @customer_contact.middle_name, phone: @customer_contact.phone }
    end
  ...
  test "should update customer_contact" do
    put :update, id: @customer_contact, customer_contact: { cell: @customer_contact.cell, designation: @customer_contact.designation, email: @customer_contact.email, first_name: @customer_contact.first_name, last_name: @customer_contact.last_name, middle_name: @customer_contact.middle_name, phone: @customer_contact.phone }
    assert_redirected_to customer_contact_path(assigns(:customer_contact))
  end
